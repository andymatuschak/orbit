declare module "multiformats" {
  ...
  interface Multihash {
    ...
    encode(bytes: Uint8Array, id: string): Uint8Array;
    hash(bytes: Uint8Array, key: string): Promise<Uint8Array>;
    has(id: number | string): boolean;
    get(id: number | string): MultihashImplementation;
  ...
  interface Multibase {
    ...
    encode: (bytes: Uint8Array, id: string) => string;
  ...
  export class CID {
    static from(value: CID | string | Uint8Array): CID;
  ...
  interface Multiformats {
    ...
    multicodec: {
      add<T>(
        value:
          | MulticodecImplementation<T>
          | MulticodecImplementation<T>[]
          | ((context: Multiformats) => MulticodecImplementation<T>),
      ): void;
      get(input: string | number | Uint8Array): MultihashImplementation;
      has(id: string | number): boolean;
