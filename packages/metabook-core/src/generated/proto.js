...
$root.Prompt = (function () {
  ...
  Object.defineProperty(Prompt.prototype, "prompt", {
    get: $util.oneOfGetter(
      ($oneOfFields = ["basicPrompt", "applicationPrompt", "clozePrompt"]),
    ),
  ...
  Prompt.encode = function encode(message, writer) {
    ...
    if (
      message.basicPrompt != null &&
      Object.hasOwnProperty.call(message, "basicPrompt")
    )
      $root.QuestionAnswerPrompt.encode(
        message.basicPrompt,
        writer.uint32(/* id 1, wireType 2 =*/ 10).fork(),
      ).ldelim();
    if (
      message.applicationPrompt != null &&
      Object.hasOwnProperty.call(message, "applicationPrompt")
    )
      $root.ApplicationPrompt.encode(
        message.applicationPrompt,
        writer.uint32(/* id 2, wireType 2 =*/ 18).fork(),
      ).ldelim();
    if (
      message.clozePrompt != null &&
      Object.hasOwnProperty.call(message, "clozePrompt")
    )
      $root.ClozePrompt.encode(
        message.clozePrompt,
  ...
  Prompt.decode = function decode(reader, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.basicPrompt = $root.QuestionAnswerPrompt.decode(
            reader,
            reader.uint32(),
          );
          break;
        case 2:
          message.applicationPrompt = $root.ApplicationPrompt.decode(
            reader,
            reader.uint32(),
          );
          break;
        case 3:
          message.clozePrompt = $root.ClozePrompt.decode(
            reader,
            reader.uint32(),
          );
          break;
  ...
  Prompt.verify = function verify(message) {
    ...
    if (message.basicPrompt != null && message.hasOwnProperty("basicPrompt")) {
      properties.prompt = 1;
      {
        ...
        if (error) return "basicPrompt." + error;
      }
    }
    if (
      message.applicationPrompt != null &&
      message.hasOwnProperty("applicationPrompt")
    ) {
      if (properties.prompt === 1) return "prompt: multiple values";
      properties.prompt = 1;
      {
        var error = $root.ApplicationPrompt.verify(message.applicationPrompt);
        if (error) return "applicationPrompt." + error;
      }
    }
    if (message.clozePrompt != null && message.hasOwnProperty("clozePrompt")) {
      ...
      properties.prompt = 1;
      {
        ...
        if (error) return "clozePrompt." + error;
      }
    }
    return null;
  };
  ...
  Prompt.fromObject = function fromObject(object) {
    ...
    if (object.basicPrompt != null) {
      ...
      message.basicPrompt = $root.QuestionAnswerPrompt.fromObject(
        object.basicPrompt,
      );
    }
    if (object.applicationPrompt != null) {
      ...
      message.applicationPrompt = $root.ApplicationPrompt.fromObject(
        object.applicationPrompt,
      );
    }
  ...
  Prompt.toObject = function toObject(message, options) {
    ...
    var object = {};
    if (message.basicPrompt != null && message.hasOwnProperty("basicPrompt")) {
      object.basicPrompt = $root.QuestionAnswerPrompt.toObject(
        message.basicPrompt,
        options,
      );
      if (options.oneofs) object.prompt = "basicPrompt";
    }
    if (
      message.applicationPrompt != null &&
      message.hasOwnProperty("applicationPrompt")
    ) {
      object.applicationPrompt = $root.ApplicationPrompt.toObject(
        message.applicationPrompt,
        options,
      );
      if (options.oneofs) object.prompt = "applicationPrompt";
    }
    if (message.clozePrompt != null && message.hasOwnProperty("clozePrompt")) {
      object.clozePrompt = $root.ClozePrompt.toObject(
        message.clozePrompt,
        options,
      );
      if (options.oneofs) object.prompt = "clozePrompt";
    }
    return object;
  };
...
$root.ApplicationPrompt = (function () {
   ...
   * @returns {$protobuf.Writer} Writer
   */
  ApplicationPrompt.encodeDelimited = function encodeDelimited(
    message,
    writer,
  ) {
    return this.encode(message, writer).ldelim();
  ...
  ApplicationPrompt.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.ApplicationPrompt();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          ...
          message.variants.push(
            $root.QuestionAnswerPrompt.decode(reader, reader.uint32()),
          );
          break;
        default:
          reader.skipType(tag & 7);
  ...
  ApplicationPrompt.verify = function verify(message) {
    ...
    if (message.variants != null && message.hasOwnProperty("variants")) {
      if (!Array.isArray(message.variants)) return "variants: array expected";
  ...
  ApplicationPrompt.fromObject = function fromObject(object) {
    if (object instanceof $root.ApplicationPrompt) return object;
    ...
    if (object.variants) {
      ...
      for (var i = 0; i < object.variants.value; ++i) {
        ...
        message.variants[i] = $root.QuestionAnswerPrompt.fromObject(
          object.variants[i],
        );
      }
    }
  ...
  ApplicationPrompt.toObject = function toObject(message, options) {
    if (!options) options = {};
    var object = {};
    if (options.arrays || options.defaults) object.variants = [];
    if (message.variants && message.variants.length) {
      object.variants = [];
      for (var j = 0; j < message.variants.length; ++j)
        object.variants[j] = $root.QuestionAnswerPrompt.toObject(
          message.variants[j],
          options,
        );
    }
...
$root.QuestionAnswerPrompt = (function () {
  ...
  QuestionAnswerPrompt.encode = function encode(message, writer) {
    ...
    if (
      ...
      Object.hasOwnProperty.call(message, "explanation")
    )
   ...
   * @returns {$protobuf.Writer} Writer
   */
  QuestionAnswerPrompt.encodeDelimited = function encodeDelimited(
    message,
    writer,
  ) {
    return this.encode(message, writer).ldelim();
  ...
  QuestionAnswerPrompt.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.QuestionAnswerPrompt();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  QuestionAnswerPrompt.verify = function verify(message) {
    ...
    if (message.question != null && message.hasOwnProperty("question"))
      if (!$util.isString(message.question)) return "question: string expected";
    if (message.answer != null && message.hasOwnProperty("answer"))
      if (!$util.isString(message.answer)) return "answer: string expected";
  ...
  QuestionAnswerPrompt.fromObject = function fromObject(object) {
    if (object instanceof $root.QuestionAnswerPrompt) return object;
    var message = new $root.QuestionAnswerPrompt();
    if (object.question != null) message.question = String(object.question);
    if (object.answer != null) message.answer = String(object.answer);
...
$root.ClozePrompt = (function () {
  ...
  ClozePrompt.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.ClozePrompt();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          message.promptMedium = reader.string();
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  ClozePrompt.fromObject = function fromObject(object) {
    if (object instanceof $root.ClozePrompt) return object;
    var message = new $root.ClozePrompt();
    if (object.body != null) message.promptMedium = String(object.body);
    return message;
  };
...
$root.ActionLog = (function () {
  ...
  Object.defineProperty(ActionLog.prototype, "log", {
    get: $util.oneOfGetter(
      ($oneOfFields = ["ingest", "repetition", "reschedule", "updateMetadata"]),
    ),
    set: $util.oneOfSetter($oneOfFields),
  });
  ...
  ActionLog.encode = function encode(message, writer) {
    ...
    if (
      ...
      $root.ActionLog.Repetition.encode(
        message.repetition,
        writer.uint32(/* id 3, wireType 2 =*/ 26).fork(),
      ).ldelim();
    if (
      message.reschedule != null &&
      Object.hasOwnProperty.call(message, "reschedule")
    )
      $root.ActionLog.Reschedule.encode(
        message.reschedule,
        writer.uint32(/* id 4, wireType 2 =*/ 34).fork(),
      ).ldelim();
    if (
      message.updateMetadata != null &&
      Object.hasOwnProperty.call(message, "updateMetadata")
    )
      $root.ActionLog.UpdateMetadata.encode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.ingest = $root.ActionLog.Ingest.decode(
            reader,
            reader.uint32(),
          );
          break;
        case 3:
          message.repetition = $root.ActionLog.Repetition.decode(
            reader,
            reader.uint32(),
          );
          break;
        case 4:
          message.reschedule = $root.ActionLog.Reschedule.decode(
            reader,
            reader.uint32(),
          );
          break;
        case 5:
          message.updateMetadata = $root.ActionLog.UpdateMetadata.decode(
            reader,
            reader.uint32(),
          );
          break;
  ...
  ActionLog.verify = function verify(message) {
    ...
    if (message.reschedule != null && message.hasOwnProperty("reschedule")) {
      ...
      properties.log = 1;
      {
        ...
        if (error) return "reschedule." + error;
      }
    }
    if (
      message.updateMetadata != null &&
      message.hasOwnProperty("updateMetadata")
    ) {
      if (properties.log === 1) return "log: multiple values";
      properties.log = 1;
      {
        var error = $root.ActionLog.UpdateMetadata.verify(
          message.updateMetadata,
        );
        if (error) return "updateMetadata." + error;
      }
    }
    return null;
  };
  ...
  ActionLog.fromObject = function fromObject(object) {
    if (object instanceof $root.ActionLog) return object;
    ...
    if (object.repetition != null) {
      ...
      message.repetition = $root.ActionLog.Repetition.fromObject(
        object.repetition,
      );
    }
    if (object.reschedule != null) {
      ...
      message.reschedule = $root.ActionLog.Reschedule.fromObject(
        object.reschedule,
      );
    }
    if (object.updateMetadata != null) {
      ...
      message.updateMetadata = $root.ActionLog.UpdateMetadata.fromObject(
  ...
  ActionLog.toObject = function toObject(message, options) {
    ...
    if (message.ingest != null && message.hasOwnProperty("ingest")) {
      ...
      if (options.oneofs) object.log = "ingest";
    }
    if (message.repetition != null && message.hasOwnProperty("repetition")) {
      object.repetition = $root.ActionLog.Repetition.toObject(
        message.repetition,
        options,
      );
      if (options.oneofs) object.log = "repetition";
    }
    if (message.reschedule != null && message.hasOwnProperty("reschedule")) {
      object.reschedule = $root.ActionLog.Reschedule.toObject(
        message.reschedule,
        options,
      );
      if (options.oneofs) object.log = "reschedule";
    }
    if (
      message.updateMetadata != null &&
      message.hasOwnProperty("updateMetadata")
    ) {
      object.updateMetadata = $root.ActionLog.UpdateMetadata.toObject(
        message.updateMetadata,
        options,
      );
      if (options.oneofs) object.log = "updateMetadata";
    }
    return object;
  };
  ...
  ActionLog.Ingest = (function () {
    ...
    Ingest.encode = function encode(message, writer) {
      ...
      if (
        message.taskID != null &&
        Object.hasOwnProperty.call(message, "taskID")
      )
        writer.uint32(/* id 1, wireType 2 =*/ 10).string(message.taskID);
      if (
        message.provenance != null &&
        Object.hasOwnProperty.call(message, "provenance")
      )
        $root.ActionLog.Provenance.encode(
          message.provenance,
          writer.uint32(/* id 2, wireType 2 =*/ 18).fork(),
        ).ldelim();
      return writer;
    ...
    Ingest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.ActionLog.Ingest();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
            ...
            break;
          case 2:
            message.provenance = $root.ActionLog.Provenance.decode(
              reader,
              reader.uint32(),
            );
            break;
    ...
    Ingest.verify = function verify(message) {
      ...
      if (message.provenance != null && message.hasOwnProperty("provenance")) {
        ...
        if (error) return "provenance." + error;
      }
      return null;
    };
    ...
    Ingest.fromObject = function fromObject(object) {
      if (object instanceof $root.ActionLog.Ingest) return object;
      ...
      if (object.provenance != null) {
        ...
        message.provenance = $root.ActionLog.Provenance.fromObject(
          object.provenance,
        );
      }
      return message;
    ...
    Ingest.toObject = function toObject(message, options) {
      ...
      if (message.provenance != null && message.hasOwnProperty("provenance"))
        object.provenance = $root.ActionLog.Provenance.toObject(
          message.provenance,
          options,
        );
      return object;
  ...
  ActionLog.Repetition = (function () {
    ...
    Repetition.encode = function encode(message, writer) {
      ...
      if (message.taskParameters != null && message.taskParameters.length)
        for (var i = 0; i < message.taskParameters.length; ++i)
          $root.ActionLog.MetadataEntry.encode(
            message.taskParameters[i],
    ...
    Repetition.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.ActionLog.Repetition();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
          ...
          case 6:
            ...
            message.taskParameters.push(
              $root.ActionLog.MetadataEntry.decode(reader, reader.uint32()),
            );
            break;
          case 7:
    ...
    Repetition.verify = function verify(message) {
      ...
      if (message.taskID != null && message.hasOwnProperty("taskID"))
        if (!$util.isString(message.taskID)) return "taskID: string expected";
      if (
        message.taskParameters != null &&
        message.hasOwnProperty("taskParameters")
      ) {
        if (!Array.isArray(message.taskParameters))
          return "taskParameters: array expected";
        for (var i = 0; i < message.taskParameters.value; ++i) {
          var error = $root.ActionLog.MetadataEntry.verify(
            message.taskParameters[i],
          );
          if (error) return "taskParameters." + error;
        }
      }
      if (message.outcome != null && message.hasOwnProperty("outcome"))
        if (!$util.isString(message.outcome)) return "outcome: string expected";
    ...
    Repetition.fromObject = function fromObject(object) {
      if (object instanceof $root.ActionLog.Repetition) return object;
      var message = new $root.ActionLog.Repetition();
      if (object.taskID != null) message.taskID = String(object.taskID);
      if (object.taskParameters) {
        if (!Array.isArray(object.taskParameters))
          throw TypeError(
            ".ActionLog.Repetition.taskParameters: array expected",
          );
        message.taskParameters = [];
        for (var i = 0; i < object.taskParameters.value; ++i) {
          if (typeof object.taskParameters[i] !== "object")
            throw TypeError(
              ".ActionLog.Repetition.taskParameters: object expected",
            );
          message.taskParameters[i] = $root.ActionLog.MetadataEntry.fromObject(
            object.taskParameters[i],
          );
        }
      }
      if (object.outcome != null) message.outcome = String(object.outcome);
    ...
    Repetition.toObject = function toObject(message, options) {
      if (!options) options = {};
      var object = {};
      if (options.arrays || options.defaults) object.taskParameters = [];
      if (options.defaults) {
        object.taskID = "";
        object.outcome = "";
        object.context = "";
      ...
      if (message.taskParameters && message.taskParameters.length) {
        ...
        for (var j = 0; j < message.taskParameters.length; ++j)
          object.taskParameters[j] = $root.ActionLog.MetadataEntry.toObject(
            message.taskParameters[j],
            options,
          );
      }
      if (message.outcome != null && message.hasOwnProperty("outcome"))
  ...
  ActionLog.Reschedule = (function () {
    ...
    Reschedule.encode = function encode(message, writer) {
      ...
      if (
        ...
        writer.uint32(/* id 1, wireType 2 =*/ 10).string(message.taskID);
      if (
        message.newTimestamp != null &&
        Object.hasOwnProperty.call(message, "newTimestamp")
      )
        $root.google.protobuf.Timestamp.encode(
    ...
    Reschedule.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.ActionLog.Reschedule();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
            ...
            break;
          case 2:
            message.newTimestamp = $root.google.protobuf.Timestamp.decode(
              reader,
              reader.uint32(),
            );
            break;
    ...
    Reschedule.verify = function verify(message) {
      ...
      if (
        message.newTimestamp != null &&
        message.hasOwnProperty("newTimestamp")
      ) {
        var error = $root.google.protobuf.Timestamp.verify(
          message.newTimestamp,
        );
        if (error) return "newTimestamp." + error;
      }
      return null;
    };
    ...
    Reschedule.fromObject = function fromObject(object) {
      if (object instanceof $root.ActionLog.Reschedule) return object;
      var message = new $root.ActionLog.Reschedule();
      if (object.taskID != null) message.taskID = String(object.taskID);
      if (object.newTimestamp != null) {
        if (typeof object.newTimestamp !== "object")
          throw TypeError(
            ".ActionLog.Reschedule.newTimestamp: object expected",
          );
        message.newTimestamp = $root.google.protobuf.Timestamp.fromObject(
          object.newTimestamp,
        );
      }
      return message;
    ...
    Reschedule.toObject = function toObject(message, options) {
      ...
      if (
        ...
        object.newTimestamp = $root.google.protobuf.Timestamp.toObject(
          message.newTimestamp,
          options,
        );
      return object;
  ...
  ActionLog.UpdateMetadata = (function () {
    ...
    UpdateMetadata.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.ActionLog.UpdateMetadata();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    UpdateMetadata.fromObject = function fromObject(object) {
      if (object instanceof $root.ActionLog.UpdateMetadata) return object;
  ...
  ActionLog.MetadataEntry = (function () {
    ...
    MetadataEntry.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.ActionLog.MetadataEntry();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    MetadataEntry.fromObject = function fromObject(object) {
      if (object instanceof $root.ActionLog.MetadataEntry) return object;
      var message = new $root.ActionLog.MetadataEntry();
      if (object.key != null) message.key = String(object.key);
      if (object.string != null) message.string = String(object.string);
      if (object.number != null) message.number = Number(object.number);
      return message;
    };
    ...
    MetadataEntry.toObject = function toObject(message, options) {
      ...
      if (message.number != null && message.hasOwnProperty("number")) {
        object.number =
          options.json && !isFinite(message.number)
  ...
  ActionLog.Provenance = (function () {
    ...
    Provenance.encode = function encode(message, writer) {
      if (!writer) writer = $Writer.create();
      if (
        message.provenanceType != null &&
        Object.hasOwnProperty.call(message, "provenanceType")
      )
        writer
          .uint32(/* id 1, wireType 2 =*/ 10)
          .string(message.provenanceType);
      if (
      ...
      if (
        message.modificationTimestamp != null &&
        Object.hasOwnProperty.call(message, "modificationTimestamp")
      )
        $root.google.protobuf.Timestamp.encode(
          message.modificationTimestamp,
          writer.uint32(/* id 3, wireType 2 =*/ 26).fork(),
        ).ldelim();
    ...
    Provenance.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.ActionLog.Provenance();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
          ...
          case 2:
            ...
            break;
          case 3:
            message.modificationTimestamp = $root.google.protobuf.Timestamp.decode(
              reader,
              reader.uint32(),
            );
            break;
    ...
    Provenance.verify = function verify(message) {
      ...
      if (
        message.provenanceType != null &&
        message.hasOwnProperty("provenanceType")
      )
      ...
      if (
        message.modificationTimestamp != null &&
        message.hasOwnProperty("modificationTimestamp")
      ) {
        var error = $root.google.protobuf.Timestamp.verify(
          message.modificationTimestamp,
        );
        if (error) return "modificationTimestamp." + error;
      }
    ...
    Provenance.fromObject = function fromObject(object) {
      if (object instanceof $root.ActionLog.Provenance) return object;
      ...
      if (object.modificationTimestamp != null) {
        if (typeof object.modificationTimestamp !== "object")
          throw TypeError(
            ".ActionLog.Provenance.modificationTimestamp: object expected",
          );
        message.modificationTimestamp = $root.google.protobuf.Timestamp.fromObject(
    ...
    Provenance.toObject = function toObject(message, options) {
      ...
      if (
        ...
        object.modificationTimestamp = $root.google.protobuf.Timestamp.toObject(
          message.modificationTimestamp,
          options,
        );
      if (message.title != null && message.hasOwnProperty("title"))
