...
export interface IActionLog {
    ...
    reschedule?: (ActionLog.IReschedule|null);

    /** ActionLog updateMetadata */
    updateMetadata?: (ActionLog.IUpdateMetadata|null);
}
...
export class ActionLog implements IActionLog {
    ...
    /** ActionLog reschedule. */
    public reschedule?: (ActionLog.IReschedule|null);

    /** ActionLog updateMetadata. */
    public updateMetadata?: (ActionLog.IUpdateMetadata|null);

    /** ActionLog log. */
    public log?: ("ingest"|"repetition"|"reschedule"|"updateMetadata");
...
export namespace ActionLog {
    ...
    interface IRepetition {
        ...
        taskParameters?: (ActionLog.IMetadataEntry[]|null);
    ...
    class Repetition implements IRepetition {
        ...
        /** Repetition taskParameters. */
        public taskParameters: ActionLog.IMetadataEntry[];
    ...
    interface IReschedule {
        ...
        newTimestamp?: (google.protobuf.ITimestamp|null);
    }
    ...
    class Reschedule implements IReschedule {
         ...
         * @param [properties] Properties to set
         */
        constructor(properties?: ActionLog.IReschedule);

        /** Reschedule taskID. */
        public taskID: string;

        /** Reschedule newTimestamp. */
        public newTimestamp?: (google.protobuf.ITimestamp|null);
         ...
         */
        public static create(properties?: ActionLog.IReschedule): ActionLog.Reschedule;
         ...
         * @returns Writer
         */
        public static encode(message: ActionLog.IReschedule, writer?: $protobuf.Writer): $protobuf.Writer;
         ...
         * @returns Writer
         */
        public static encodeDelimited(message: ActionLog.IReschedule, writer?: $protobuf.Writer): $protobuf.Writer;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): ActionLog.Reschedule;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): ActionLog.Reschedule;
         ...
         * @returns Reschedule
         */
        public static fromObject(object: { [k: string]: any }): ActionLog.Reschedule;
         ...
         * @returns Plain object
         */
        public static toObject(message: ActionLog.Reschedule, options?: $protobuf.IConversionOptions): { [k: string]: any };
    ...
    /** Represents an UpdateMetadata. */
    class UpdateMetadata implements IUpdateMetadata {

        /**
         * Constructs a new UpdateMetadata.
         * @param [properties] Properties to set
         */
        constructor(properties?: ActionLog.IUpdateMetadata);
         ...
         * @param [properties] Properties to set
         * @returns UpdateMetadata instance
         */
        public static create(properties?: ActionLog.IUpdateMetadata): ActionLog.UpdateMetadata;

        /**
         * Encodes the specified UpdateMetadata message. Does not implicitly {@link ActionLog.UpdateMetadata.verify|verify} messages.
         * @param message UpdateMetadata message or plain object to encode
         * @param [writer] Writer to encode to
         * @returns Writer
         */
        public static encode(message: ActionLog.IUpdateMetadata, writer?: $protobuf.Writer): $protobuf.Writer;
         ...
         * @returns Writer
         */
        public static encodeDelimited(message: ActionLog.IUpdateMetadata, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
         * Decodes an UpdateMetadata message from the specified reader or buffer.
         * @param reader Reader or buffer to decode from
         * @param [length] Message length if known beforehand
         * @returns UpdateMetadata
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): ActionLog.UpdateMetadata;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): ActionLog.UpdateMetadata;
         ...
         * @returns UpdateMetadata
         */
        public static fromObject(object: { [k: string]: any }): ActionLog.UpdateMetadata;

        /**
         * Creates a plain object from an UpdateMetadata message. Also converts values to other types if specified.
         * @param message UpdateMetadata
         * @param [options] Conversion options
         * @returns Plain object
         */
        public static toObject(message: ActionLog.UpdateMetadata, options?: $protobuf.IConversionOptions): { [k: string]: any };
    ...
    class MetadataEntry implements IMetadataEntry {
         ...
         * @param [properties] Properties to set
         */
        constructor(properties?: ActionLog.IMetadataEntry);
         ...
         */
        public static create(properties?: ActionLog.IMetadataEntry): ActionLog.MetadataEntry;
         ...
         * @returns Writer
         */
        public static encode(message: ActionLog.IMetadataEntry, writer?: $protobuf.Writer): $protobuf.Writer;
         ...
         * @returns Writer
         */
        public static encodeDelimited(message: ActionLog.IMetadataEntry, writer?: $protobuf.Writer): $protobuf.Writer;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): ActionLog.MetadataEntry;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): ActionLog.MetadataEntry;
         ...
         * @returns MetadataEntry
         */
        public static fromObject(object: { [k: string]: any }): ActionLog.MetadataEntry;
         ...
         * @returns Plain object
         */
        public static toObject(message: ActionLog.MetadataEntry, options?: $protobuf.IConversionOptions): { [k: string]: any };
